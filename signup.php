	...
	else
	{
		...
		{			
			...
			$message = "					
						Hello $uname,
						<br /><br />
						Welcome to Poll page!<br/>
						To complete your registration  please , just click following link<br/>
						<br /><br />
						<a href='http://localhost/diplomna/signup-email-verification/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
						<br /><br />
						Thanks,";
